...
bg_image = pygame.image.load('labwork7/ex1/images/mainclock.png')
sec_img = pygame.image.load('labwork7/ex1/images/leftarm.png')
min_img = pygame.image.load('labwork7/ex1/images/rightarm.png')
