...
player = pygame.image.load("labwork7/ex2/images/player.jpg") #main object
process = True #for cycle "for"
playlist = ["labwork7/ex2/music/music1.mp3", "labwork7/ex2/music/music2.mp3" , "labwork7/ex2/music/music3.mp3"] #list of musics
index_of_playlist = 0
def play_music():
